	   ...
	   (async(sterm) => {
		   	 ...
		   	 try{
				    ...
				    const querySpec3 = {
				                ...
				                query: "SELECT TOP 10 * FROM c WHERE c.summary_IC = @keyword order by c._ts desc",
				      		parameters : [
							{
								name : '@keyword',
								value : sterm
           ...
           (async(sterm) => {
                         ...
                         try{
                                    ...
                                    const querySpec3 = {
                                                ...
                                                query: "SELECT * FROM c where c.MCA_COMPANY_NAME LIKE @keyword OR c.MCA_CIN LIKE @keyword OR c.AKA_Brand_Name OR c.ACTACY_INDUSTRIAL_CLASSIFICATION LIKE @keyword", 
